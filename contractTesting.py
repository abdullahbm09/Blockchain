...
truffleFile = json.load(open(PATH_SC_TRUFFLE + '/build/contracts/Arduino.json'))
abi = truffleFile['abi']
...
contractAddress =  '0xe383c870285fee1ab63ccf8c426bf8bf29492588'
...
while(True):
    ...
    if(receipt is not None):
        if(receipt['status'] == '0x1'):
            ...
            print('newly deployed contract at address {}'.format(contractAddress1))
        else:
...
value1 = 90 # random numbers here
function = 'input1(uint value)' # from smart contract
